...
console.log(`The diet of the velociraptor is ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`The length of the stegosaurus is ${stegosaurus.length}`);

// What time period did tyrannosaurus live in?
console.log(`The period of time the tyrannosaurus lived in was ${tyrannosaurus.period}`);
...
const uni = graduates.map(grad=>grad.university).filter(uni=>uni.includes('Uni'));
console.log(uni);
...
*/
const lowerPopulation = zooAnimals.filter(ani=>ani.population<5);
